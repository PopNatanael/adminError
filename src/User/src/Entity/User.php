...
class User extends AbstractEntity implements UserInterface
{
    ...
    public const USER_YEARONE = '1';
    public const USER_YEARTWO = '2';
    public const USER_YEARTHREE = '3';
    public const USER_YEARFOUR = '4';
    ...
    public function setYear(string $year): UserInterface
    {
        $this->year = $year;
